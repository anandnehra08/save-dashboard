        ...
        if st.button("🔍 Search Student"):
            if supabase:
                ...
                if res.data:
                    ...
                    # Store selected SR for deletion handling
...
render_student_module = render_students_moduleimport pandas as pd
import streamlit as st
from database.supabase import supabase
